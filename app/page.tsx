...
export default function Home() {
  ...
  return (
    <Box
      bgcolor="#f6f7fb"
      className="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-200 via-slate-100 to-white p-6"
    >
            ...
            >
              <CardContent>
                ...
                <Stack spacing={1.2} mb={4}>
                  <Typography>• Real-time updates with SSE</Typography>
                  <Typography>• Full order history and role-based access</Typography>
                  <Typography>
